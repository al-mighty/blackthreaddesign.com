...
The official docs page for [Matrix4](http://threejs.dev/docs/#api/math/Matrix4) has some more information on this, as well as details on the common matrices used. 
