...
There are lots other ways of specifying colors in three.js - see the [Color](threejs.org/docs/#api/math/Color) docs for details - but hex triples are the most commonly used and the method we'll be sticking with in these tutorials. 
