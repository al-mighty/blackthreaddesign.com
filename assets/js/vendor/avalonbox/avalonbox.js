...
const Avalonbox = ( function () {
  let doc = document;
  let buttons = {};
  let overlay = html.createOverlayBox( doc );
  let frame = html.createFrame( doc );
  let spinner = html.createSpinner( doc );
  let spinnerWrapper = html.createSpinnerWrapper( doc );
  ...
  function single( query ) {
      let links = doc.getElementById( query ).getElementsByTagName( 'a' );
